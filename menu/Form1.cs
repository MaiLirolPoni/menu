...
namespace menu
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("CC derechos totalmente reservados por Coco", "Acerca de...", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void timesNewRomanToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            label1.Font = new Font("Times New Roman", 36, label1.Font.Style);
        ...
        private void comicSansToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            label1.Font = new Font("Comic Sans", 34, label1.Font.Style);
